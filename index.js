...
let cardElement = Elements.querySelector('.element');
let buttonLike = cardElement.querySelector('.element__button');

cardElement.addEventListener('click', function like(){
